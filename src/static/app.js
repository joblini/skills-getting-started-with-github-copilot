              ...
              <ul class="participants-list no-bullets">
                ${details.participants.map(p => `
                  <li style="display: flex; align-items: center;">
                    <span>${p}</span>
                    <button class="delete-participant" data-activity="${name}" data-email="${p}" title="Remove participant" style="margin-left: 8px; background: none; border: none; cursor: pointer; color: #c62828; font-size: 18px;">🗑️</button>
                  </li>
                `).join("")}
              </ul>
            </div>
